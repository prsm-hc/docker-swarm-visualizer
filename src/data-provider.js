...
let physicalStructProvider = ([initialNodes, initialContainers]) => {
  ...
  let addContainer = (container) => {
    ...
    let imageTag ="<div style='height: 100%; padding: 5px 5px 5px 5px;' onclick='window.open(\"//vpn.prsmcare.com:9000/#/containers/" + cloned.Status.ContainerStatus.ContainerID + "\")'>"+
